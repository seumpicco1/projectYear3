...
import { getUser } from "./dataHandleUser.js"
import { getData } from "./dataHandle.js"
...
// Catagory
    ...
    return { userData, annData, getAnnData, getOneAnnData, postCreateAnn, putUpdateAnn, deleteAnn, getActiveOrCloseMode, getUserData, deleteUser, getCategoriesId}
})
